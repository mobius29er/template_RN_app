...
const socialLinks = [
  ...
  { name: 'GitHub', icon: Github, href: 'https://github.com/yourcompany' },
  { name: 'LinkedIn', icon: Linkedin, href: 'https://linkedin.com/company/yourcompany' },
  { name: 'Email', icon: Mail, href: 'mailto:hello@yourcompany.com' },
];
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-sm">
              ...
              stress less, and achieve your goals faster.
            </p>
            {/* Social Links */}
